  ...
  return (
    <LegalLayout>
      ...
      <section className="space-y-3 text-sm leading-6 text-foreground/90">
        ...
        <p>
          By using SheetLog, you agree to these terms. If you do not agree, do not use the service.
        </p>
      </section>
      ...
      <section className="space-y-3 text-sm leading-6 text-foreground/90">
        ...
        <p>
          SheetLog helps you record financial transactions and sync them to a Google Sheet in your
          Google account. The app runs in your browser and uses Google APIs to write data to your
          sheet.
        </p>
      </section>
      ...
      <section className="space-y-3 text-sm leading-6 text-foreground/90">
        ...
        <ul className="list-disc space-y-2 pl-5">
          <li>
            You are responsible for the accuracy of the data you enter and for securing access to
            your Google account.
          </li>
          <li>
            You may only use the service in compliance with applicable laws and Google&apos;s terms.
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-3 text-sm leading-6 text-foreground/90">
        ...
        <p>
          We may modify, suspend, or discontinue the service at any time. We may update these terms,
          and continued use of the service means you accept the updated terms.
        </p>
      </section>
      ...
      <section className="space-y-3 text-sm leading-6 text-foreground/90">
        ...
        <p>
          ...
          fullest extent permitted by law, we disclaim warranties of any kind and will not be liable
