    ...
    >
      <div className="flex flex-col items-center justify-center h-full pb-20 space-y-6 text-center animate-in fade-in zoom-in-95 duration-500">
        <div className="relative">
          ...
          <div className="relative flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-tr from-primary to-info text-primary-foreground ring-4 ring-background">
