        ...
        {customHeader ? (
          ...
          <div className="flex items-center gap-3 border-b border-border/20 pt-4 pb-3">
            <button
              type="button"
              aria-label="Go back"
              className="rounded-full p-2 hover:bg-muted transition-colors -ml-2 active:scale-95 touch-manipulation focus-visible:ring-2 focus:outline-none focus-visible:ring-primary"
              onClick={onBack}
            >
        ...
        <div className="flex items-center gap-2">
          {onDelete && (
            <button
              ...
              className={cn(
                "flex items-center justify-center gap-2 rounded-2xl border border-destructive/30 bg-destructive/10 px-4 py-3 text-sm font-semibold text-destructive active:scale-95 touch-manipulation focus-visible:ring-2 focus:outline-none focus-visible:ring-destructive",
          ...
          <button
            type="button"
            className="flex flex-1 items-center justify-center gap-2 rounded-2xl bg-primary py-3 text-sm font-semibold text-primary-foreground disabled:cursor-not-allowed disabled:opacity-60 active:scale-95 touch-manipulation focus-visible:ring-2 focus:outline-none focus-visible:ring-primary"
            onClick={onSubmit}
            disabled={isSubmitting || isDeleting}
          >
